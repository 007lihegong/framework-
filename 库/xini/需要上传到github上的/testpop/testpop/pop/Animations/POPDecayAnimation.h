...
/**
 ...
 提供一个过阻尼效果(其实Spring是一种欠阻尼效果)，可以实现类似UIScrollView的滑动衰减效果(是的 你可以靠它来自己实现一个UIScrollView)
...
/**
 ...
 之前设置动画开始占初始速度。表达的变化值单位每秒。只有POPValueTypes支持速度:kPOPValuePoint kPOPValueInteger,kPOPValueFloat kPOPValueRect,kPOPValueSize。
 */
